    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-8 pb-4 border-b border-b-blue-gray">
        ...
        <div className="text-start">
          ...
          <Input label="Price" id="price" name="price" type="number" required />
        </div>
        <div className="text-start">
          <label htmlFor="sellPrice" className="flex items-center gap-1 mb-2">
      ...
      <div className="pb-3 mb-6 border-b border-b-blue-gray grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        <div className="text-start">
          <label htmlFor="standardShipAreas" className="mb-2 inline-block">
            Shipping Areas
          </label>
          <Input label="Area" id="standardShipAreas" name="standardShipAreas" />
        </div>
        <div className="text-start">
          <label htmlFor="standardShipTime" className="mb-2 inline-block">
            Time in days (ex: 5-6)
          </label>
          <Input label="Time" id="standardShipTime" name="standardShipTime" />
        </div>
      </div>
    </>
  );
